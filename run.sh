...
"""
# train teacher
python -u main.py --dataset=foursquare --S_backbone=bpr --train_teacher --teacher embedding_dim=800 --cfg wd=0.01 --suffix teacher
...
python -u main.py --dataset=foursquare --S_backbone=lightgcn --model=scratch --student embedding_dim=10 num_layers=1 --cfg wd=0.01 --suffix student

python -u main.py --dataset=citeulike --S_backbone=bpr --model=scratch --student embedding_dim=20 --cfg wd=1e-3 --suffix student
...
python -u main.py --dataset=citeulike --S_backbone=bpr --T_backbone=bpr --train_teacher --teacher embedding_dim=400 --cfg wd=1e-3 --no_log --ckpt_interval=50
...
python -u main.py --dataset=citeulike --S_backbone=bpr --T_backbone=bpr --model=filterd
python -u main.py --dataset=citeulike --S_backbone=bpr --T_backbone=bpr --model=fd
...
python -u main.py --dataset=citeulike --S_backbone=lightgcn --T_backbone=lightgcn --model=cpd
python -u main.py --dataset=citeulike --S_backbone=lightgcn --T_backbone=lightgcn --model=rrd


python -u main.py --dataset=foursquare --S_backbone=bpr --T_backbone=bpr --model=de
python -u main.py --dataset=foursquare --S_backbone=bpr --T_backbone=bpr --model=cpd
python -u main.py --dataset=foursquare --S_backbone=bpr --T_backbone=bpr --model=nkd
python -u main.py --dataset=foursquare --S_backbone=bpr --T_backbone=bpr --model=graphd
python -u main.py --dataset=foursquare --S_backbone=bpr --T_backbone=bpr --model=filterd

python -u main.py --dataset=foursquare --S_backbone=lightgcn --T_backbone=lightgcn --model=nkd
...
python -u main.py --dataset=gowalla --S_backbone=bpr --T_backbone=bpr --model=cpd
python -u main.py --dataset=gowalla --S_backbone=bpr --T_backbone=bpr --model=graphd

python -u main.py --dataset=gowalla --S_backbone=lightgcn --T_backbone=lightgcn --model=graphd


python -u main.py --dataset=yelp --S_backbone=bpr --T_backbone=bpr --model=de
python -u main.py --dataset=yelp --S_backbone=bpr --T_backbone=bpr --model=cpd
...
"""
# train teacher
python -u main_ctr.py --dataset=criteo --S_backbone=crossnet --train_teacher --suffix teacher
python -u main_ctr.py --dataset=criteo --S_backbone=dnn --train_teacher --suffix teacher
python -u main_ctr.py --dataset=criteo --S_backbone=dcnv2 --train_teacher --suffix teacher
python -u main_ctr.py --dataset=criteo --S_backbone=cin --train_teacher --suffix teacher
python -u main_ctr.py --dataset=criteo --S_backbone=xdeepfm --train_teacher --suffix teacher
python -u main_ctr.py --dataset=criteo --S_backbone=autoint --train_teacher --suffix teacher
python -u main_ctr.py --dataset=criteo --S_backbone=eulernet --train_teacher --suffix teacher
python -u main_ctr.py --dataset=criteo --S_backbone=gatecrossnet --train_teacher --suffix teacher

# from scratch
python -u main_ctr.py --dataset=criteo --S_backbone=crossnet --model=scratch --suffix student --no_save
python -u main_ctr.py --dataset=criteo --S_backbone=dnn --model=scratch --suffix student --no_save
python -u main_ctr.py --dataset=criteo --S_backbone=dcnv2 --model=scratch --suffix student --no_save
python -u main_ctr.py --dataset=criteo --S_backbone=gatecrossnet --model=scratch --suffix student --no_save

# KD
python -u main_ctr.py --dataset=criteo --S_backbone=crossnet --T_backbone=crossnet --model=hetd
python -u main_ctr.py --dataset=criteo --S_backbone=crossnet --T_backbone=crossnet --model=rkd
python -u main_ctr.py --dataset=criteo --S_backbone=crossnet --T_backbone=crossnet --model=bced
python -u main_ctr.py --dataset=criteo --S_backbone=crossnet --T_backbone=crossnet --model=fitnet
python -u main_ctr.py --dataset=criteo --S_backbone=crossnet --T_backbone=crossnet --model=clid
python -u main_ctr.py --dataset=criteo --S_backbone=crossnet --T_backbone=crossnet --model=paird
python -u main_ctr.py --dataset=criteo --S_backbone=crossnet --T_backbone=crossnet --model=anyd
python -u main_ctr.py --dataset=criteo --S_backbone=crossnet --T_backbone=crossnet --model=adad
python -u main_ctr.py --dataset=criteo --S_backbone=crossnet --T_backbone=crossnet --model=ofa

python -u main_ctr.py --dataset=criteo --S_backbone=dnn --T_backbone=dnn --model=bced
python -u main_ctr.py --dataset=criteo --S_backbone=dnn --T_backbone=dnn --model=fitnet
python -u main_ctr.py --dataset=criteo --S_backbone=dnn --T_backbone=dnn --model=hetd

python -u main_ctr.py --dataset=criteo --S_backbone=dcnv2 --T_backbone=dcnv2 --model=bced
python -u main_ctr.py --dataset=criteo --S_backbone=dcnv2 --T_backbone=dcnv2 --model=clid
python -u main_ctr.py --dataset=criteo --S_backbone=dcnv2 --T_backbone=dcnv2 --model=hetd

python -u main_ctr.py --dataset=criteo --S_backbone=cin --T_backbone=cin --model=fitnet
python -u main_ctr.py --dataset=criteo --S_backbone=cin --T_backbone=cin --model=hetd
python -u main_ctr.py --dataset=criteo --S_backbone=cin --T_backbone=cin --model=warmup

python -u main_ctr.py --dataset=criteo --S_backbone=gatecrossnet --T_backbone=gatecrossnet --model=fitnet
python -u main_ctr.py --dataset=criteo --S_backbone=gatecrossnet --T_backbone=gatecrossnet --model=bced