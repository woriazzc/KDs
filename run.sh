...
python -u main.py --dataset=foursquare --backbone=lightgcn --train_teacher --teacher embedding_dim=2000 --cfg wd=1e-3 --suffix teacher
...
python -u main.py --dataset=foursquare --backbone=lightgcn --train_teacher --teacher embedding_dim=10 --cfg wd=0.01 --suffix student
